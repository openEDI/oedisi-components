...
| [**Player**](Components/player/README.md) | ![Version](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/openEDI/oedisi-components/main/Components/player/pyproject.toml&query=$.project.version&label=version&color=blue) | [![Unit Tests](https://github.com/openEDI/oedisi-components/actions/workflows/unit-test-player.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/unit-test-player.yml) | [![Verify Components](https://github.com/openEDI/oedisi-components/actions/workflows/verify-components-player.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/verify-components-player.yml) | [![Verify Dockerfiles](https://github.com/openEDI/oedisi-components/actions/workflows/verify-dockerfiles-player.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/verify-dockerfiles-player.yml) | tylor.slay@pnnl.gov |
| [**PNNL-SWOD**](https://github.com/openEDI/pnnl-emt-swod/tree/316d36b8ff6fd33172d989702c3a95de14eeda5e) | [![Release](https://img.shields.io/github/v/release/openEDI/pnnl-emt-swod?sort=semver&display_name=tag)](https://github.com/openEDI/pnnl-emt-swod/releases/latest) | [![Unit Tests](https://github.com/openEDI/oedisi-components/actions/workflows/unit-test-pnnl-emt-swod.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/unit-test-pnnl-emt-swod.yml) | [![Verify Components](https://github.com/openEDI/oedisi-components/actions/workflows/verify-components-pnnl-emt-swod.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/verify-components-pnnl-emt-swod.yml) | [![Verify Dockerfiles](https://github.com/openEDI/oedisi-components/actions/workflows/verify-dockerfiles-pnnl-emt-swod.yml/badge.svg)](https://github.com/openEDI/oedisi-components/actions/workflows/verify-dockerfiles-pnnl-emt-swod.yml) | tylor.slay@pnnl.gov |
...
- **[player](Components/player/README.md)** - Dataset playback federate for replaying recorded HELICS co-simulation data
- **[pnnl-emt-swod](Components/pnnl-emt-swod/README.md)** - Transient sliding wave oscillation detection (SWOD) federate
