...
from .omoo import run_simulator
...
def main():
    """Entry point for omoo-server console script."""
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PORT", "5685")))
